...
const static char page_01[] = "<!DOCTYPE html>\n"
						   "<html>\n"
						   "<head>\n"
						   "<title>ESP32 Weather Monitor Station</title>\n"
...
const static char html_row_01[] = "<div class=\"row\">\n"
						   "<div class=\"column\" >\n";

const static char gauge_temp[] = "<h2>Temperature</h2>\n"
						   ...
						   "data-highlights='[ {\"from\": 30, \"to\": 50, \"color\": \"rgba(200, 50, 50, .75)\"} ]'\n"
...
const static char html_row_02[] = "\"\n"
						    "></canvas>\n"
                            "</div>\n"
						   "<div class=\"column\">\n";

const static char gauge_hum[] = "<h2>Humidity</h2>\n"
...
const static char  html_row_03[] ="\"\n"
						   "></canvas>\n"
						   "</div>\n"
						   "</div>\n";

const static char gauge_pres[] = "<h2>Pressure</h2>\n"
						   "<canvas data-type=\"radial-gauge\"\n"
						   "data-width=\"300\"\n"
						   "data-height=\"300\"\n"
						   "data-units=\"kPa\"\n"
						   "data-min-value=\"70\"\n"
						   "data-max-value=\"130\"\n"
						   "data-major-ticks=\"[70,80,90,100,110,120,130]\"\n"
						   "data-minor-ticks=\"2\"\n"
						   "data-stroke-ticks=\"true\"\n"
						   "data-highlights='[ {\"from\": 70, \"to\": 100, \"color\": \"rgba(0,0, 255, .3)\"},\n"
						   "{\"from\": 100, \"to\": 130, \"color\": \"rgba(255, 0, 0, .3)\"} ]'\n"
...
const static char gauge_co2[] = "<h2>CO2</h2>\n"
						   "<canvas data-type=\"linear-gauge\"\n"
						   "data-width=\"200\"\n"
						   "data-height=\"300\"\n"
						   "data-units=\"PPM\"\n"
						   ...
						   "data-major-ticks=\"0,500,1000,1500,2000,3000,4000,5000,6000,7000,8000,9000,10000\"\n"
						   "data-minor-ticks=\"2\"\n"
						   "data-stroke-ticks=\"true\"\n"
						   "data-highlights='[ {\"from\": 1500, \"to\": 10000, \"color\": \"rgba(200, 50, 50, .75)\"} ]'\n"
						   "data-color-plate=\"#fff\"\n"
						   "data-border-shadow-width=\"0\"\n"
						   "data-borders=\"false\"\n"
						   "data-needle-type=\"arrow\"\n"
...
const static char page_03[] = "</table>\n"
						   "</body>\n"
						   "<script>\n"
